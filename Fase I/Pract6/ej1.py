...
class ej1(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "ej1", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("ej1")
        ...
        self.settings = Qt.QSettings("GNU Radio", "ej1")
        ...
        # Variables
        ##################################################
        self.tablaverdad_constelacion = tablaverdad_constelacion = (1+0j, 0+1j, -1+0j, 0-1j)
        self.Sps = Sps = 8
        self.Rs = Rs = 32000
        self.M = M = len(tablaverdad_constelacion)
        ...
        self.digital_chunks_to_symbols_xx_0 = digital.chunks_to_symbols_bc(tablaverdad_constelacion, 1)
    ...
    def get_tablaverdad_constelacion(self):
        return self.tablaverdad_constelacion

    def set_tablaverdad_constelacion(self, tablaverdad_constelacion):
        self.tablaverdad_constelacion = tablaverdad_constelacion
        self.set_M(len(self.tablaverdad_constelacion))
        self.digital_chunks_to_symbols_xx_0.set_symbol_table(self.tablaverdad_constelacion)
...
def main(top_block_cls=ej1, options=None):
