...
class pruebapromediadorvectorial(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "pruebapromediadorvectorial")
        ...
        self.blocks_vector_source_x_0 = blocks.vector_source_f((1,2,3,4,5,6,7,8), True, 1, [])
...
def main(top_block_cls=pruebapromediadorvectorial, options=None):
