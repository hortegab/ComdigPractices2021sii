...
class pruebarectsignal(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "pruebarectsignal")
...
def main(top_block_cls=pruebarectsignal, options=None):
